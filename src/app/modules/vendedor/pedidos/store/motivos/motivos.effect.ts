...
import {   
    GET_MOTIVOS_NO_PEDIDO,
    GetMotivosAction, 
    SetMotivosAction
} from './motivos.actions';
import {HttpParams} from '@angular/common/http';
import {IMotivo} from '../../../../../interfaces/IMotivo';
import {ApiService} from '../../../../../services/api/api.service';
import {NavigationHelper} from '../../../../../helpers/navigation/navigation.helper';
import {Storage} from '@ionic/storage';
import {AppState} from './motivos.reducer';
        ...
        mergeMap((action: GetMotivosAction) => {
            ...
            return this.api.get('getMotivosNoPedido', params)
                .pipe(
                   ...
                   map((motivoService: IMotivo[]) => new SetMotivosAction(motivoService))
                ).pipe(
                    catchError((error) => {
